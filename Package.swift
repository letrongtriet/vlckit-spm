...
let vlcBinary = Target.binaryTarget(name: "VLCKit-all", url: "https://github.com/letrongtriet/vlckit-spm/releases/download/4.0.0a13/VLCKit-all.xcframework.zip", checksum: "")
